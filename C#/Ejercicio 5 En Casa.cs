internal class Program
{
    ...
    {
        double cant, opc, total, precioIVA , descuento , totalcon ;
        string forma;
        ...
        switch (opc)
        {
            case 1:
                ...
                descuento = (precioIVA) * (10.0 / 100.0);
            ...
            case 3:
                ...
                total = 650 * cant;
                precioIVA = total * 1.12;
                descuento = (precioIVA) * (15.0 / 100.0);
                totalcon = precioIVA - descuento;
                break;
        ...
        Console.WriteLine("Total sin descuento (con IVA): Q" + precioIVA.ToString("F2"));
        Console.WriteLine("Forma de pago: " + forma);
        Console.WriteLine("Descuento realizado: Q" + descuento.ToString("F2"));
        Console.WriteLine("Total a pagar: Q" + totalcon.ToString("F2"));
    }
}